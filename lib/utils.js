...
// Variables
var releaseUrl = null
var additionalScripts = pluginDetection.getMergedArraySync('scripts', pluginDetection.transform.scopePublicScriptPaths)
...
exports.matchRoutes = function (req, res) {
  ...
  var model = {additionalScripts}
  res.render(path, model, function (err, html) {
    if (err) {
      res.render(path + '/index', model, function (err2, html) {
        if (err2) {
